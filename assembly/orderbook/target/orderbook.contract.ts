...
//       this.receiver,
//       Name.fromU64(0x334D9361A696A250),
//     );
...
//       this.receiver,
//       Name.fromU64(0x334D9361A696A230),
//     );
...
class marketOrderAction implements _chain.Packer {
    ...
    pack(): u8[] {
        ...
        enc.packString(this.side);
        enc.pack(this.amount!);
        enc.packNumber<u16>(this.max_slippage_bp);
        return enc.getBytes();
    }
    ...
    unpack(data: u8[]): usize {
        ...
        this.max_slippage_bp = dec.unpackNumber<u16>();
        return dec.getPos();
    }
...
class processLimitAction implements _chain.Packer {
    ...
    pack(): u8[] {
        let enc = new _chain.Encoder(this.getSize());
        enc.packNumber<u64>(this.pair_id);
        enc.packNumber<i32>(this.max_orders);
        return enc.getBytes();
    }
    ...
    unpack(data: u8[]): usize {
        let dec = new _chain.Decoder(data);
        this.pair_id = dec.unpackNumber<u64>();
        this.max_orders = dec.unpackNumber<i32>();
        return dec.getPos();
    }
...
export function apply(receiver: u64, firstReceiver: u64, action: u64): void {
	...
	if (receiver == firstReceiver) {
		...
		if (action == 0x91AF0566974AAE00) {//marketorder
            ...
            args.unpack(actionData);
            mycontract.marketOrder(args.user!,args.pair_id,args.side,args.amount!,args.max_slippage_bp);
        }
